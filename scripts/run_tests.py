...
def run_all_tests(verbose: bool = False, coverage: bool = True, exclude_slow: bool = True) -> int:
    """运行所有测试"""
...
"""
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "all", "quick", "smoke", "specific",
            "lint", "security-scan", "coverage", "clean", "install"
        ],
        help="要执行的测试类型或操作"
    )
    ...
    if args.command == "install":
        ...
        return run_all_tests(args.verbose, not args.no_coverage, not args.include_slow)
