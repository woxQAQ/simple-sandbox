...
class EntrypointTemplates:
    ...
    @staticmethod
    def create_python_entrypoint(encrypted_code: dict, key_b64: str) -> str:
...
'''
    ...
    @staticmethod
    def create_nodejs_entrypoint(encrypted_code: dict, key_b64: str) -> str:
...
"""
    ...
    def create_entrypoint(
        language: str, encrypted_code: dict, key_b64: str
    ) -> str:
        """创建指定语言的入口点"""
        if language.lower() == "python":
            return EntrypointTemplates.create_python_entrypoint(
                encrypted_code, key_b64
            )
