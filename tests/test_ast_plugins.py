...
class TestJSTransformerIntegration:
    ...
    def test_js_ast_transformer_file_exists(self):
        ...
        # 测试插件文件存在
        console_plugin_path = "src/runtime/extensions/ast_plugins/js_plugins/console_plugin.js"
        import_plugin_path = "src/runtime/extensions/ast_plugins/js_plugins/import_plugin.js"
...
class TestASTIntegration:
    ...
    def test_transform_ast_code_function(self):
        ...
        try:
            result = transform_ast_code(js_code, "javascript", filename="test.js")
